...
Если есть ошибки (обычно это `GATT_INTERNAL_ERROR` со значением 129), следует сделать отключение устройства, потому что-то исправить тут невозможно. Вы просто отключаете и пробуете снова подключиться.
