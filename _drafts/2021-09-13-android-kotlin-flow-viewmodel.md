...
Теперь вы знаете все компромисы при переходе от LiveData к подходу "полностью на Flow" в вашем Android-UI слое.